...
contract DeployLuxbinUSDCStakingUltraLowMin is Script {
    function run() external {
        ...
        // Deploy the ultra low-minimum version
        LuxbinUSDCStaking_UltraLowMin staking = new LuxbinUSDCStaking_UltraLowMin(usdcAddress, oracleAddress);

        vm.stopBroadcast();

        // Log the deployment
        console.log("LuxbinUSDCStaking_UltraLowMin deployed to:", address(staking));
        console.log("USDC Address:", usdcAddress);
        console.log("Oracle Address:", oracleAddress);
        console.log("MINIMUM STAKE: 1 USDC (Ultra Low Minimum - FOR TESTING ONLY)");
    }
}